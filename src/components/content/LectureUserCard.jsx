    ...
    return (
        <Card sx={{ maxWidth: 345, display: 'flex', flexDirection: 'column', position: 'relative' }}>
            ...
            <CardActions disableSpacing>
                ...
                <FilledHoverBtn sx={{ width: '100%', bgcolor: (lecture.index === currentIndex) ? 'orange' : 'primary.main' }}
                    ...
                    {lecture.index === lectureIndex ? 'المحاضره قيد التشغيل' : lecture.index === currentIndex ? "المحاضره التاليه" : lecture.index < currentIndex ? 'تم الانتهاء' : "ابدا الان"}
                </FilledHoverBtn>
